...
<html lang="en">
  ...
  <body>
    ...
    <p class="text-4xl ... text-center mt-3"> Índice Nacional Precios Consumidor</p>
  </head>
  <body>
  <div class="container m-3 p-3">
    ...
    <script>
        ...
        var year1 = {!! json_encode($year) !!};
        var mes1 = {!! json_encode($mes) !!};
        var indice1 = {!! json_encode($indice) !!};
        var variacion1 = {!! json_encode($variacion) !!};
        
        //var year = year1.toReversed();
       // var mes = mes1.toReversed();
        //var indice = indice1.toReversed();
        //var variacion = variacion1.toReversed();
      ...
      // Specify the configuration items and data for the chart
        ...
        option = {
          ...
          legend: {
            data: ['year','mes', 'variacion', 'indice']
          },
          toolbox: {
            show: true,
            orient: 'vertical',
